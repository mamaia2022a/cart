...
export class PendingMemPage implements OnInit {
  ...
  constructor(private store: Store, private navController: NavController, private platform: Platform, private storage: Storage)  
  {
    ...
    this.getLocalStorageData()
            .then(async data =>{
              ...
              this.store.dispatch(new AuthAction.MemGrupMembriInAsteptare(
  ...
  selectieMembruGrup(memMembrugrupId : number) 
  {
    ...
    //this.storage.set("backaction","/sefgrup/gestgrup/pendingmem");
    var backaction = "/sefgrup/gestgrup/pendingmem";
