...
@Component({
  selector: 'app-excluderemem',
  templateUrl: './excluderemem.page.html',
  styleUrls: ['./excluderemem.page.scss'],
})
export class ExcludereMemPage implements OnInit {

  frmExcludereMembru : FormGroup = new FormGroup(
    {
  ...
  getLocalStorageData(){
    ...
    /**
    if (this.frmExcludereMem.valid) {
      console.log(this.frmExcludereMem.value);
    }*/
  }
  ...
  onExcludereMembru() {
    if (this.frmExcludereMembru.valid) 
    {
      console.log(this.frmExcludereMembru.value);
      /** 
  ...
  ngOnInit(){
    //this.frmExcludereMem = new FormControl('', [Validators.required, Validators.email]);
