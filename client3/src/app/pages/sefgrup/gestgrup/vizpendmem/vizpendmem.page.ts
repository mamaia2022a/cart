...
@Component({
  selector: 'app-vizpendmem',
  templateUrl: './vizpendmem.page.html',
  styleUrls: ['./vizpendmem.page.scss'],
})
export class VizPendMemPage implements OnInit {

  frmVizPendMemerea: FormGroup = new FormGroup(
    {
  ...
  getLocalStorageData(){
    ...
    /**
    if (this.frmVizPendMem.valid) {
      console.log(this.frmVizPendMem.value);
    }*/
  }
  ...
  onVizPendMemerea() {
    if (this.frmVizPendMemerea.valid) 
    {
      console.log(this.frmVizPendMemerea.value);
  ...
  ngOnInit(){
    //this.frmVizPendMem = new FormControl('', [Validators.required, Validators.email]);
